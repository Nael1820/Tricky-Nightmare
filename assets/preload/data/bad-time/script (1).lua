function onCreate()
	if dadName == 'tricky-dem' then
		makeAnimatedLuaSprite('animatedicon', 'icons/NightmaretrickyIcons', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatedicon', 'normal', 'normal', 25, true)
		addAnimationByPrefix('animatedicon', 'losing', 'loss', 25, true)
